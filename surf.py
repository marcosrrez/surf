...
from surf_backends import (
    ...
    ddg_search, brave_search, tavily_search, searxng_search,
...
def _run_setup() -> None:
    ...
    print()
    cfg["SEARXNG_URL"] = _setup_prompt(
        "SearXNG URL (self-hosted, unlimited — e.g. http://192.168.1.100:8080)",
        cfg.get("SEARXNG_URL", ""), secret=False
    )
    print()
    ...
    key_order = [
        ...
        "SEARXNG_URL", "SYNTHESIS_MODEL", "OBSIDIAN_VAULT", "CLAUDE_MONTHLY_BUDGET",
    ]
    written = set()
